 403 Forbidden while accessing https://github.com/bdalgarn/networks-hw/info/refs
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
#include <errno.h>
...
int main(int argc, char *argv[]){
        ...
        /* Builds Socket */
        if ((sock = socket(PF_INET,SOCK_STREAM)) == -1) {
        ...
        if ((sendto(sock,buf,sizeof(buf),0,(struct sock_addr *)server) < 0)){
